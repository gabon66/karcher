...
angular.module('angucomplete', [] )
    .directive('angucomplete', function ($rootScope,$parse, $http, $sce, $timeout) {
        return {
            restrict: 'EA',
            scope: {
                "id": "@id",
            ...
            link: function($scope, elem, attrs) {
                ...
                $scope.selectResult = function(result) {
                    ...
                    $rootScope.autocompleteSelected=$scope.selectedObject;
                    $scope.showDropdown = false;
                    $scope.results = [];
                    //$scope.$apply();
                }
                ...
                elem.on("keyup", function (event) {
                    ...
                    if(event.which === 40) {
                        ...
                        if ($scope.searchStr==""){
                            $rootScope.autocompleteSelected=null;
                        }
